...
module tb_riscv_soc_wrapper;
  ...
  logic jtag_tck_i     ; // JTAG test clock 
  logic jtag_nreset_i  ; // JTAG test reset 
  ...
  always #10 jtag_tck_i = ~ jtag_tck_i ; // 50 MHz APB
  ...
  logic            jtag_tms_i     ; // JTAG test mode select
    logic            jtag_tdi_i     ; // JTAG test data input
  logic            jtag_tdo_o     ; // JTAG test data output
